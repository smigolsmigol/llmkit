...
import { CLAUDE_PRICING } from './pricing-data.js';

// per-million token rates (USD). Generated from pricing.json (anthropic models only).
// Extra dated variants used by Claude Code that aren't in the main pricing table.
const PRICING: Record<string, { input: number; output: number; cacheRead: number; cacheWrite: number }> = {
  ...CLAUDE_PRICING,
  'claude-opus-4-5-20251101': CLAUDE_PRICING['claude-opus-4-5'] || { input: 5, output: 25, cacheRead: 0.5, cacheWrite: 6.25 },
  'claude-sonnet-4-5-20251022': CLAUDE_PRICING['claude-sonnet-4-5'] || { input: 3, output: 15, cacheRead: 0.3, cacheWrite: 3.75 },
  'claude-haiku-4-5-20251001': CLAUDE_PRICING['claude-haiku-4-5'] || { input: 1, output: 5, cacheRead: 0.1, cacheWrite: 1.25 },
  'claude-haiku-3-5-20241022': CLAUDE_PRICING['claude-3-5-haiku-20241022'] || { input: 0.8, output: 4, cacheRead: 0.08, cacheWrite: 1 },
};
