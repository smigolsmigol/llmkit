...
const sharedReadme = readFileSync('docs/integrations/shared.md', 'utf8');
...
test('shared guide pricing summary matches pricing.json', () => {
  ...
  assert(
    ...
    'shared guide pricing count and date must match pricing.json',
  );
});
